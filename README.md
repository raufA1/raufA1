...
<picture>
  ...
  <img alt="Rauf Alizade - AI-First Developer" src="social_preview.PNG" width="100%">
</picture>
...
We are at the beginning of a fundamental shift in software development 🚀.
...
[Repo →](https://github.com/raufA1/smart-cli)
...
[Repo →](https://github.com/raufA1/clipflow)

```mermaid
%%{init: {
  "theme":"dark",
  "themeVariables":{"fontSize":"20px","lineColor":"#94a3b8"},
...
[Repo →](https://github.com/raufA1/llm-family-pack)
